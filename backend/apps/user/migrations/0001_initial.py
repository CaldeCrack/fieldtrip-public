# Generated by Django 5.2 on 2026-03-18 19:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('emergency_contact', models.CharField(max_length=30, null=True, verbose_name='Contacto de emergencia')),
                ('emergency_number', models.IntegerField(null=True, validators=[apps.user.models.validate_emergency_number], verbose_name='Número de emergencia')),
                ('role', models.CharField(choices=[('teacher', 'Teacher'), ('student', 'Student'), ('admin', 'Admin'), ('inventory_manager', 'Inventory Manager')], max_length=20, verbose_name='Role')),
                ('has_previous_experience', models.BooleanField(default=True, verbose_name='¿Tiene experiencia previa en salidas a campo?')),
                ('diet_info', models.CharField(blank=True, default='', help_text='Ejemplo: "No como azúcar"', max_length=100, verbose_name='Información extra de alimentación')),
