"""
Django settings for fieldtrip project.
...
ALLOWED_HOSTS = config(
    'ALLOWED_HOSTS', default='127.0.0.1,localhost,http://localhost:8081,*', cast=Csv())
...
WSGI_APPLICATION = 'fieldtrip.wsgi.application'
